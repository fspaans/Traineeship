package nl.fs.winkelservlet.Webwinkel;

import java.util.Scanner;
import java.util.function.Predicate;

import nl.fs.winkelservlet.Webwinkel.bestelling.Winkelwagen;
import nl.fs.winkelservlet.Webwinkel.product.Beperkt;
import nl.fs.winkelservlet.Webwinkel.product.DefaultProduct;
import nl.fs.winkelservlet.Webwinkel.product.KwantumKorting;
import nl.fs.winkelservlet.Webwinkel.product.Product;
import nl.fs.winkelservlet.Webwinkel.product.Voedsel;
